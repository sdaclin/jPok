...
public class HandAnalyser5 implements HandAnalyser {
	...
	/*
	 * (non-Javadoc)
	 * @see net.pokerprobability.helper.service.io.github.sdaclin.jpok.analyzer.HandAnalyser#getHandStrength(net.pokerprobability.enumeration.Card[], net.pokerprobability.enumeration.Card[])
	 */
