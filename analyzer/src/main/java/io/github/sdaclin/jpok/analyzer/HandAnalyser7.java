...
import io.github.sdaclin.jpok.tools.ArrayTools;
 ...
 *
 */
public class HandAnalyser7 implements HandAnalyser {
	...
	/*
	 * (non-Javadoc)
	 * @see poker.common.analyser.io.github.sdaclin.jpok.analyzer.HandAnalyser#getHandStrength(poker.common.bean.Hand, poker.common.bean.Table)
	 */
